$(document).ready(function () {
    ...
    // Format nilai awal (mis. hasil old() setelah validasi gagal)
    ...
    $(document).on('click', '.editBtn', function () {
        ...
        $('#editFee').val(formatCurrency(parseInt(btn.data('fee'), 10) || 0));
        $('#editForm').attr('action', `/updatepricing/${btn.data('id')}`);
