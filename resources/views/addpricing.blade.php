        ...
        <div class="p-5">
            <div class="w-full bg-white rounded-md h-fit mx-auto">
                <div class="p-3 text-center">
                    <h1 class="font-extrabold text-3xl">Add pricing</h1>
                </div>
                <div class="p-6 space-y-4">
                    ...
                    @endif
                    <form id="storeForm" class="space-y-10" method="post" action="{{ route('postpricing') }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text"
                                ...
                                id="name" name="name" placeholder="Pajak" value="{{ old('name') }}" required />
                        </div>
                        <div class="space-y-2">
                            <label class="font-semibold text-black">Fee:</label>
                            <input type="number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-md w-full"
                                id="fee" name="fee" placeholder="2" value="{{ old('fee') }}" required />
                                                                    <p id="feeOutput">Rp.</p>
                        </div>
