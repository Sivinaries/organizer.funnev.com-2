...
@php
    ...
    $variantClasses = match ($variant) {
        'gray' => 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:bg-gray-100 disabled:text-gray-400 disabled:border-gray-200 disabled:cursor-not-allowed',
        'emerald' => 'bg-emerald-600 text-white hover:bg-emerald-700 disabled:bg-emerald-400 disabled:cursor-not-allowed shadow-md',
        ...
        'red' => 'bg-red-500 text-white hover:bg-red-600 disabled:bg-red-400 disabled:cursor-not-allowed shadow-md',
