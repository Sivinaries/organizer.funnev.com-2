        ...
        <div class="p-5">
            <div class="w-full bg-white rounded-md h-fit mx-auto">
                <div class="p-3 text-center">
                    <h1 class="font-extrabold text-3xl">Edit ticket</h1>
                </div>
                <div class="p-6 space-y-4">
                    ...
                    @endif
                    <form id="editForm" class="space-y-10" method="post" action="{{ route('updateticket', ['id' => $ticket->id]) }}"
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <div class="space-y-2">
                                    ...
                                    <input type="text"
                                        ...
                                        id="type" name="type" value="{{ $ticket->type }}" required />
                                </div>
                                <div class="space-y-2">
                                    <label class="font-semibold text-black">Price:</label>
                                    <input type="number"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-md w-full"
                                        id="price" name="price" value="{{ $ticket->price }}" required />
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-2">
                                <div class="space-y-2">
                                    ...
                                    <input type="number"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-md w-full"
                                        id="pcs" name="pcs" value="{{ $ticket->pcs }}" required />
                                </div>
                                <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-md w-full h-44" id="desc"
                                name="desc" placeholder="Description" required>{{ $ticket->desc }}</textarea>
                        </div>
