@php
    $eventsForHot = \App\Models\Event::select('id', 'event')->get();
@endphp
...
<div id="addModal"
    ...
    <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl relative my-5 flex flex-col max-h-[90vh]">
        ...
        <div class="p-8 overflow-y-auto">
            <form id="addForm" method="post" action="{{ route('posthot') }}" novalidate data-validate class="space-y-6">
                @csrf
                <div>
